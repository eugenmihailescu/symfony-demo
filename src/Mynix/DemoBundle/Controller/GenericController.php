...
class GenericController extends Controller {
	...
	private function validateEntity($entity_name = null) {
		...
		if (empty ( $entity_name ) || ! class_exists ( 'Mynix\DemoBundle\Entity\\' . $entity_name )) {
	...
	private function getFieldAnnotations($field_name, $annotation_name) {
		$reflectionProperty = new \ReflectionProperty ( 'Mynix\DemoBundle\Entity\\' . $this->entity, $field_name );
	...
	private function getFieldType($field_name) {
		...
		$annotation = $this->getFieldAnnotations ( $field_name, 'Mynix\DemoBundle\Annotation\FormFieldTypeAnnotation' );
	...
	private function getFieldChoices($field_name) {
		...
		$lookupAnnotation = $this->getFieldAnnotations ( $field_name, 'Mynix\DemoBundle\Annotation\LookupAnnotation' );
	...
	protected function getEntityAnnotations($annotation_name, $entity_name = null) {
		...
		$reflectionEntity = new \ReflectionClass ( 'Mynix\DemoBundle\Entity\\' . $entity_name );
