...
// src/MynixSymfonyDemoBundle/Security/PostVoter.php
namespace MynixSymfonyDemoBundle\Security;

use Symfony\Component\Security\Core\Authentication\Token\TokenInterface;
use Symfony\Component\Security\Core\Authorization\Voter\Voter;
use Symfony\Component\Security\Core\User\User;
use Doctrine\Common\Annotations\AnnotationReader;
use MynixSymfonyDemoBundle\Controller\ExceptionController;
...
class EntityVoter extends Voter {
	...
	public function __construct(\Twig_Environment $twig, $debug) {
		...
		$this->entity = 'MynixSymfonyDemoBundle\Entity\\' . $parts [self::ENTITY_PATH_LEVEL];
		
		try {
			$annotations = $this->getEntityAnnotations ( $this->entity, 'MynixSymfonyDemoBundle\Annotation\EntityAnnotation' );
		} catch ( \Exception $e ) {
