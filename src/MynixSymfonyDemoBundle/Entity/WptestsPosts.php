...
use MynixSymfonyDemoBundle\Validator\Constraints\ForeignKey;
use MynixSymfonyDemoBundle\Annotation\FormFieldTypeAnnotation;
use MynixSymfonyDemoBundle\Annotation\EntityAnnotation;
...
class WptestsPosts {
	 ...
	 * @LookupAnnotation(target_entity="MynixSymfonyDemoBundle\Entity\WptestsUsers", lookup_function="getUserNicename")
	 *
	 * @var integer
	 */
	 ...
	 * Set author
	 *
	 * @param \MynixSymfonyDemoBundle\Entity\WptestsUsers $author        	
	 *
	 * @return WptestsPosts
	 */
	public function setAuthor(\MynixSymfonyDemoBundle\Entity\WptestsUsers $author = null) {
		$this->author = $author;
	 ...
	 * Get author
	 *
	 * @return \MynixSymfonyDemoBundle\Entity\WptestsUsers
	 */
