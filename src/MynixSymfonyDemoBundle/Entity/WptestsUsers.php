...
class WptestsUsers {
	 ...
	 * Add post
	 *
	 * @param \MynixSymfonyDemoBundle\Entity\WptestsPosts $post        	
	 *
	 * @return WptestsUsers
	 */
	public function addPost(\MynixSymfonyDemoBundle\Entity\WptestsPosts $post) {
		$this->posts [] = $post;
	 ...
	 * @param \MynixSymfonyDemoBundle\Entity\WptestsPosts $post        	
	 */
	public function removePost(\MynixSymfonyDemoBundle\Entity\WptestsPosts $post) {
