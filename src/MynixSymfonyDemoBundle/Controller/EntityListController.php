...
final class EntityListController extends GenericController {
	public function browseEntitiesAction($page, $limit) {
		...
		foreach ( $meta as $m ) {
			...
			$annotation = $this->getEntityAnnotations ( 'MynixSymfonyDemoBundle\Annotation\EntityAnnotation', $key );
		...
		$html = $templating->render ( 'MynixSymfonyDemoBundle:entity:list.html.twig', array (
				'data' => $entities,
				'pages' => $page_count,
				'page' => $page,
				'limit' => $limit,
