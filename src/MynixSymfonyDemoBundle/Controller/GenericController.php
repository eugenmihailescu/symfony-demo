...
use MynixSymfonyDemoBundle\Annotation\LookupAnnotation;
...
class GenericController extends Controller {
	...
	private function validateEntity($entity_name = null) {
		...
		if (empty ( $entity_name ) || ! class_exists ( 'MynixSymfonyDemoBundle\Entity\\' . $entity_name )) {
	...
	private function getFieldAnnotations($field_name, $annotation_name) {
		$reflectionProperty = new \ReflectionProperty ( 'MynixSymfonyDemoBundle\Entity\\' . $this->entity, $field_name );
	...
	private function getFieldType($field_name) {
		...
		$annotation = $this->getFieldAnnotations ( $field_name, 'MynixSymfonyDemoBundle\Annotation\FormFieldTypeAnnotation' );
	...
	private function getFieldChoices($field_name) {
		...
		$lookupAnnotation = $this->getFieldAnnotations ( $field_name, 'MynixSymfonyDemoBundle\Annotation\LookupAnnotation' );
	...
	protected function getPost($id) {
		...
		$post = $this->getDoctrine ()->getRepository ( 'MynixSymfonyDemoBundle:' . $this->entity )->find ( $id );
	...
	protected function getPostFields($include_id = true) {
		...
		$fields = $em->getClassMetadata ( 'MynixSymfonyDemoBundle:' . $this->entity )->getFieldNames ();
		
		$annotation = $this->getEntityAnnotations ( 'MynixSymfonyDemoBundle\Annotation\EntityAnnotation' );
	...
	protected function getEntityAnnotations($annotation_name, $entity_name = null) {
		...
		$reflectionEntity = new \ReflectionClass ( 'MynixSymfonyDemoBundle\Entity\\' . $entity_name );
