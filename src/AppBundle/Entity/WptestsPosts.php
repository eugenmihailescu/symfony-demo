...
use AppBundle\Validator\Constraints\ForeignKey;
use AppBundle\Annotation\FormFieldTypeAnnotation;
...
class WptestsPosts {
	 ...
	 * @LookupAnnotation(target_entity="AppBundle\Entity\WptestsUsers", lookup_function="getUserNicename")
	 *
	 * @var integer
	 */
	 ...
	 * Set author
	 *
	 * @param \AppBundle\Entity\WptestsUsers $author        	
	 *
	 * @return WptestsPosts
	 */
	public function setAuthor(\AppBundle\Entity\WptestsUsers $author = null) {
		$this->author = $author;
	 ...
	 * Get author
	 *
	 * @return \AppBundle\Entity\WptestsUsers
	 */
