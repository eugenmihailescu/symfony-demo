...
class WptestsUsers {
	 ...
	 * Add post
	 *
	 * @param \AppBundle\Entity\WptestsPosts $post        	
	 *
	 * @return WptestsUsers
	 */
	public function addPost(\AppBundle\Entity\WptestsPosts $post) {
		$this->posts [] = $post;
	 ...
	 * @param \AppBundle\Entity\WptestsPosts $post        	
	 */
	public function removePost(\AppBundle\Entity\WptestsPosts $post) {
